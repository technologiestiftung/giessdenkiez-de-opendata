...
sql_query = "SELECT t.id, t.lat, t.lng, t.bezirk, t.art_dtsch, t.gattung_deutsch, t.strname, t.pflanzjahr, w.timestamp, w.amount FROM trees_watered AS w JOIN trees AS t ON w.tree_id=t.id "
